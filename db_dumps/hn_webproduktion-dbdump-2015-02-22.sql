...
-- Dumping data for table hn_webproduktion.menu_links: ~7 rows (approximately)
/*!40000 ALTER TABLE `menu_links` DISABLE KEYS */;
INSERT INTO `menu_links` (`mlid`, `title`, `path`, `plid`, `weight`) VALUES
	(21, 'gad', 'gad', NULL, 0),
	(22, 'asdasdawe', 'asdasda', NULL, 0),
	(23, 'gggad2', 'gaaad2', 21, 0),
	(24, 'TESTT', 'Teest', NULL, 0),
	(25, 'Stuffufuuf', 'Stuffuffuff', NULL, 0),
	(26, 'work?', 'workii', NULL, 0),
	(27, 'Idontknow', 'Idonteven', NULL, 0);
...
-- Dumping data for table hn_webproduktion.pages: ~0 rows (approximately)
...
-- Dumping data for table hn_webproduktion.url_alias: ~0 rows (approximately)
