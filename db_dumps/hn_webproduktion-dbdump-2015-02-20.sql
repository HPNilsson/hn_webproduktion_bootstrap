...
-- Dumping data for table hn_webproduktion.images: ~1 rows (approximately)
...
-- Dumping data for table hn_webproduktion.menu_links: ~4 rows (approximately)
...
-- Dumping data for table hn_webproduktion.pages: ~13 rows (approximately)
...
INSERT INTO `pages` (`pid`, `title`, `body`, `img_id`, `user_id`, `video_id`, `created`) VALUES
	...
	(16, 'Bogeli', '			aw2ras							', NULL, 1, NULL, '2015-02-20 17:01:33'),
	(17, 'MEHE', '			meeeeeeeeh							', NULL, 1, NULL, '2015-02-20 17:29:28');
...
-- Dumping data for table hn_webproduktion.url_alias: ~13 rows (approximately)
