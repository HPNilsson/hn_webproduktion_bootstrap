...
--
-- Värd: localhost
-- Tid vid skapande: 13 feb 2015 kl 15:38
...
ALTER TABLE `menu_links`
 ADD PRIMARY KEY (`mlid`), ADD KEY `plid` (`plid`), ADD KEY `menu` (`menu`);
...
ADD CONSTRAINT `menu_links_ibfk_2` FOREIGN KEY (`menu`) REFERENCES `menus` (`machine_name`);
